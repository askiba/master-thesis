...
Aby dobrze odwzorowaæ jazdê narciarza po slalomie, nale¿y uwzglêdniæ wszystkie zachodz±ce w jego ¶rodowisku zjawiska fizyczne. W tym rozdziale pokazane zostanie w jaki sposób jest mo¿liwe zamodelowanie narciarza, stoku oraz toru, po którym siê porusza.
...
Poni¿ej umieszczony jest schemat tego algorytmu (Algorytm \ref{alg:prostyGenetyczny} oparty o algorytm umieszczony w \cite{arabas}).
