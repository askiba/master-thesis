...
Zainteresowanie tematyk± narciarsk±, sk³oni³o autorki pracy do przetestowania pewnych zale¿no¶ci i zjawisk opisywanych w tym rozdziale w terenie. Dziêki ¿yczliwo¶ci Studenckiego Klubu Narciarskiego FIRN dzia³aj±cego na Akademii Górniczo-Hutniczej w Krakowie, by³a mo¿liwo¶c dokonywania pomiarów przy u¿yciu specjalistycznego sprzêtu do pomiaru czasu na stoku narciarskim. Zosta³y ustalone nastêpuj±ce cele eksperymentów:

\begin{itemize}
\item eksperymentalne wyznaczenie wspó³czynnika tarcia statycznego miêdzy ¶niegiem a ¶lizgiem nart w zale¿no¶ci od sposobu nasmarowania ¶lizgu narty, jako¶ci ¶lizgu oraz d³ugo¶ci narty.
...
\paragraph{Za³o¿enia} 
W celu zmierzenia wspó³czynnika tarcia, zosta³a wykorzystana drewniana deska, która zosta³a przykryta wartw± ubitego, mokrego, marcowego ¶niegu. Przygotowane zosta³y cztery pary nart:
\begin{itemize}
\item Narta Atomic Race GS12, 175 cm d³ugo¶ci, stary, nieprzygotowany, jednak nie do koñca przesuszony ¶lizg
\item Narta Völkl Racetiger GS, 175 cm d³ugo¶ci, nowy, bardzo dobrze przygotowany  i nasmarowany na gor±co smarem uniwersalnym (Toko System 3)
\item Narta Atomic SL11, 150 cm d³ugo¶ci, stary, nieprzygotowany i bardzo przesuszony ¶lizg.
\item Narta Head Worldcup Rebel S
\end{itemize}
...
\begin{table}[h] 
\caption{Uruchomienie obliczeñ dla czterech ró¿nych strategii w jednej zak³adce w przegl±darce Chrome i porównanie ¶redniego czasu na znalezienie rozwi±zania.}
