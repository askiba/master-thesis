...
Dla ka¿dej z nart przeprowadzone zosta³y dwie próby i jako wynik traktowana by³a ¶rednia z tych prób. Eksperyment mia³ cel pozyskania wyniku podgl±dowego, dlatego te¿ liczba dwóch prób zosta³a uznana za wystarczaj±c±. Jako, ¿e zauwa¿ony zosta³ podczas eksperymentu ogromny wp³yw wilgotno¶ci ¶lizgu na wynik, zasta³y równie¿ przeprowadzone próby dla dwóch rodzajów nart z niewytartym ¶lizgiem, na którym zebrana by³a znaczna ilo¶æ wody.
...
Wyniki okaza³y siê byæ zgodne z przewidywaniami. Jako¶æ ¶lizgu, stan jego przegotowania oraz rodzaj smaru maj± znacz±cy wp³yw na warto¶æ wspó³czynnika tarcia, a w konsekwencji na szybko¶ci poruszania siê na nartach. Ciekawym wnioskiem by³o to, ¿e mokry ¶lizg ma znacznie wiêkszy wspó³czynnik tarcia ni¿ suchy ¶lizg. Wychodzi zatem jak wa¿na jest odpowiednio na³o¿ona na ¶lizg struktura umo¿liwiaj±ca odp³yw wody. Narta B mia³a ¶wie¿± strukturê, podczas gdy narta D prawie jej nie mia³a. 
...
\paragraph{Za³o¿enia i warunki eksperymentu} 
Kolejny eksperyment przeprowadzany by³ ju¿ tylko na stoku narciarskim - Siepraw Ski w pobli¿u Krakowa. Eksperyment mia³ na celu sprawdzenie zale¿no¶ci pomiêdzy powierzchni± narciarza a czasem jego przejazdu. Poniewa¿ za zmienn± eksperymentu przyjmujemy tylko powierzchniê narciarza, sprawdzamy tak naprawdê zale¿no¶æ pomiêdzy powierzchni± a warto¶ci± si³ oporu powietrza. Przygotowane zosta³y nastêpuj±ce scenariusze:
\begin{itemize}
...
W tej sekcji, zostan± wymienione wady i zalety zaproponowanego rozwi±zania architektonicznego opieraj±cego siê na modelu Volunteer Computing udostêpnianego za pomoc± przegl±darek internetowych (\textit{Web browser based volunteer computing}).
