...
\multirow{2}{*}{\textbf{wspó³czynnik tarcia}}                                                                            & \textbf{\begin{tabular}[c]{@{}c@{}}osuszony \\ ¶lizg\end{tabular}} & A-suchy                                        & B-suchy          & C-suchy          & D-suchy          \\ \cline{2-6} 
\multicolumn{1}{|l|}{\textbf{}}                                                                                          & \textbf{\begin{tabular}[c]{@{}c@{}}wilgotny\\  ¶lizg\end{tabular}} & ---                                            & B-mokry          & ---              & B-mokry          \\ \hline
\end{tabular}
\end{table}
...
\label{fig:eksp-2}
\centering
\includegraphics[height=220px]{eksp-2}
\caption{masa i stok}
\end{figure}
