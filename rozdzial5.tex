...
Przeprowadzenie eksperymentu okaza³o siê utrudnione przez fakt, ¿e przegl±darki optymalizuj± zu¿ycie procesora i nie rozdzielaj± mocy obliczeniowej równo pomiêdzy wszystkie otwarte w jednym czasie okna przegl±darki. Maj±c to na uwadze, zosta³y przeprowadzone dodatkowe eksperymenty maj±ce na celu zbadaæ wydajno¶æ obliczeñ gdy karta przegl±darki w której prowadzone s± obliczenia jest nie aktywna.

Chrome (v. 29)
\begin{itemize}
\item 55 sec - jedno okno przegl±darki na raz aktywna
\item 60 sec - jedno okno przegl±darki na raz, nieaktywne
...
Firefox (v. 23.01)
\begin{itemize}
\item 242 sec - jedno okno przegl±darki na raz - aktywne
