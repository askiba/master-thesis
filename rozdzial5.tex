...
\begin{tabular}{ | c | c |}
  \hline                        
  numer próby & czas przejazdu [s] \\ \hline  
1 & 7.968 \\ \hline
2 & 8.039 \\ \hline
3 & 7.917 \\ \hline
\end{tabular}\\
...
Ilo¶æ iteracji w przypadku tych wyników wynios³a 7-9. Algorytm bardzo szybko dochodzi do rozwi±zania, a czas dzia³ania algorytmu to tylko ok. 20 s. Trzeba pamiêtaæ, ¿e algorytm musi dzia³aæ wystarczaj±co d³ugo, aby mia³o sens przesy³anie problemu z serwera - najlepiej oko³o kilku minut. Wtedy czas obliczeñ bêdzie znacz±co d³u¿szy w stosunku do czasu przesy³u danych.
...
\label{fig:w6wyk}
\centering
\includegraphics[scale=0.7]{wyniki/wynik6-wyk}
\end{figure}
