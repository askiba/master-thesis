...
\end{itemize}
¦lizg ka¿dej narty przed eksperymentem by³ wycierany, tak by³o na nim osadzonych kropel stopionego ¶niegu. Wy³o¿ona ubitym ¶niegiem deska o d³ugo¶ci oko³o 2.5 metra zosta³a podparta o pod³o¿ê z jednej strony, z drugiej, pod niewielkim k±tem w stosunku do pod³o¿a by³a podtrzymywana rêk±.
...
\item na desce k³adziona by³a narta
\item na desce oznaczano miejsce, znajdowania siê ¶rodka ciê¿ko¶ci narty
...
Wyniki okaza³y siê byæ zgodne z przewidywaniami. Jako¶æ ¶lizgu, stan jego przegotowania oraz rodzaj smaru maj± znaczne znaczenie w wysoko¶ci wspó³czynnika tarcia, a w konsekwencji w szybko¶ci poruszania siê na nartach. Ciekawym wnioskiem by³o to, ¿e mokry ¶lizg ma znacznie wiêkszy wspó³czynnik tarcia ni¿ suchy ¶lizg. Wychodzi równie¿ jak wa¿na jest odpowiednio na³o¿ona na ¶lizg struktura umo¿liwiaj±ca odp³yw wody. Narta B mia³a ¶wie¿± strukturê, podczas gdy narta D prawie jej nie mia³a. 
...
\paragraph{Za³o¿enia i warunki eksperymentu} 
Kolejny eksperyment przeprowadzany by³ ju¿ na stoku narciarskim - Siepraw Ski w pobli¿u Krakowa. Eksperyment mia³ na celu sprawdzenie zale¿no¶ci pomiêdzy powierzchni± narciarza a szybko¶ci± jego przejazdu. Poniewa¿ za zmienn± eksperymentu przyjmujemy tylko powierzchniê narciarza, sprawdzamy de facto zale¿no¶æ pomiêdzy powierzchni± a warto¶ci± si³ oporu powietrza. Przygotowane zosta³y nastêpuj±ce scenariusze:
\begin{itemize}
\item narciarz ubrany jest w specjaln± tzw. gumê narciarsk± przylegaj±c± do cia³a. Strój ten opisany jest szerzej w sekcji \ref{sec:oporPowietrza} na stronie \pageref{sec:oporPowietrza}. 
\end{itemize}
