...
\begin{figure}[h]
\centering
\includegraphics{diagramClientLayers}
\label{diagramClientLayers}
\end{figure}

Diagram \ref{diagramClientLayers} przedstawia sekwencjê komunikacji pomiêdzy poszczególnymi warstwami aplikacji klienckiej.
...
\begin{figure}[h]
\centering
\includegraphics{diagramClientServerDb}
\label{diagramClientServerDb}
\end{figure}

Diagram \ref{diagramClientServerDb} pokazuje sekwencjê komunikacji pomiêdzy komponentami systemu oraz warstw± persystencji.
